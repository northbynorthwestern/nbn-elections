    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('posted_datetime', models.DateTimeField(db_index=True, auto_now_add=True, null=True)),
                ('status', models.CharField(default=b'd', max_length=1, null=True, choices=[(b'd', b'Draft'), (b'r', b'Read Me'), (b'e', b'Edited'), (b'p', b'Published')])),
                ('author', models.ManyToManyField(to='posts.Author', null=True, blank=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            model_name='post',
            name='race',
            field=models.ForeignKey(blank=True, to='posts.Race', null=True),
