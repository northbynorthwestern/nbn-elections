...
SECRET_KEY = os.environ.get('ELECTIONS_DJANGO_SECRET_KEY', None)
...
TEMPLATE_DIRS = (
    os.path.join(BASE_DIR, 'elections/templates'),
)
...
# TinyMCE Setup
TINYMCE_JS_URL = "http://nbn-elections.s3.amazonaws.com/js/tinymce/tinymce.min.js"
